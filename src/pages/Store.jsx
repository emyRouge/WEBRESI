        ...
        <section className="store-hero">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Descubre nuestros productos con propósito. Cada compra contribuye a nuestros proyectos de inclusión social
              y transforma vidas en nuestra comunidad.
            </p>
          </div>
        </section>
